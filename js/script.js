...
class Memorama {
    ...
    startGame() {
        this.foundPairs = 0;
        this.counter= 0;
        document.getElementById("intentos").innerHTML = "Intentos Realizados: " + this.counter
        this.setNewOrder();
    ...
    checkPair(image) {
        ...
        if (this.card1 && this.card2) {
            ...
            if (this.card1 == this.card2) {
                ...
                firstOpened.classList.add("rotation");
                secondOpened.classList.add("rotation");
                this.canPlay = false;
    ...
    resetOpenedCards() {
        ...
        firstOpened.classList.remove("rotation");
        secondOpened.classList.remove("rotation");
    ...
    checkIfWon() {
        ...
        if (this.maxPairNumber == this.foundPairs) {
            ...
            alert("¡Ganaste! Ronda terminada en "+this.counter+" Intentos Realizados");
            this.setNewGame();
